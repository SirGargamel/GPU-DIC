...
\end{figure}
Při otevření alespoň dvou vývojů hodnoty se otevře také okno s analýzou přetvoření mezi dvěma zadanými body. Analýza se zobrazí vždy pro dva poslední průběhy, které jsou zobrazeny (tzn. pro bod, který uživatel aktuálně označil a předchozí v případě, že nezavřel okno s průběhem nebo aktuální a poslední nezavřený graf).
\newpage
