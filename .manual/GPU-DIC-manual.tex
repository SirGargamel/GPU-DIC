...
\item[SOLVER] [BruteForce | CoarseFine | \textbf{NewtonRaphsonCentral} | NewtonRaphsonForward | NewtonRaphsonHessianEstimate] \\
Řešič použitý pro výpočet. BruteForce je kompletní prohledání všech možností na základě zadaných limitů, jedná se o nejpomalejší a nejnáročnější řešič, zaručuje ale nalezení nejvhodnějšího řešení pro zadané limity. CoarseFine je schopen urychlit výpočet za pomoci postupného zpřesňování řešení na základě hrubého odhadu. Řešič NewtonRaphson je pak implementací Newtonovi metody pro hledání maxima / minima zadané funkce. Central varianta používá centrální diferenci, Forward pak dopřednou diferenci. HessianEstimate pak nepočítá inverzi Hessiánu, ale aproximuje ji za pomoci vlastností obrazu v okolí podoblasti.
...
PARAM_SUBSET_GENERATOR_METHOD :: TIGHT
