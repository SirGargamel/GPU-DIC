...
public interface TaskDefaultValues {
    ...
    double[] DEFAULT_DEFORMATION_LIMITS_ZERO = new double[]{-5, 5, DEFAULT_PRECISION_ZERO, -5, 5, DEFAULT_PRECISION_ZERO};
    double[] DEFAULT_DEFORMATION_LIMITS_FIRST = new double[]{
        -5, 5, DEFAULT_PRECISION_ZERO, -5, 5, DEFAULT_PRECISION_ZERO,
        -0.0, 1.0, DEFAULT_PRECISION_FIRST, -0.0, 1.0, DEFAULT_PRECISION_FIRST, -0.0, 1.0, DEFAULT_PRECISION_FIRST, -0.0, 1.0, DEFAULT_PRECISION_FIRST};
