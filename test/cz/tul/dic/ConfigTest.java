...
public class ConfigTest {
    ...
    public void testConfigRealFiles() throws IOException, URISyntaxException, ComputationException {
        ...
        Assert.assertEquals(new KernelInfo(KernelInfo.Type.CL1D, KernelInfo.Input.ANY, KernelInfo.Correlation.ANY, KernelInfo.MemoryCoalescing.ANY, KernelInfo.UseLimits.ANY), task.getParameter(TaskParameter.KERNEL));
