...
public class ConfigTest {
    ...
    public void testConfigRealFiles() throws IOException, URISyntaxException, ComputationException {
        ...
        Assert.assertEquals(SubsetGenerator.EQUAL, task.getParameter(TaskParameter.SUBSET_GENERATOR_METHOD));
        ...
        Assert.assertEquals(new KernelInfo(KernelInfo.Type.CL1D, KernelInfo.Input.BEST, KernelInfo.Correlation.BEST, KernelInfo.MemoryCoalescing.BEST, KernelInfo.UseLimits.BEST), task.getParameter(TaskParameter.KERNEL));
